...
class SenderCell: UITableViewCell {
    ...
    @IBOutlet weak var sImageButton: UIButton!
}
...
class ReceiverCell: UITableViewCell {
    ...
    @IBOutlet weak var rImageButton: UIButton!
}
...
class MessagesVC: UIViewController {
    ...
    @IBOutlet weak var receiverAvatarButton: UIButton!
    ...
    override func viewDidLoad() {
        ...
        // Layouts
        receiverAvatarButton.layer.cornerRadius = receiverAvatarButton.bounds.size.width/2
        receiverAvatarButton.imageView?.contentMode = .scaleAspectFill
        ...
        // Receiver Username
        receiverUsernameLabel.text = "\(userObj[DBTable.USER_CLASS_NAME]!)"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        do { userPointer = try userPointer.fetchIfNeeded() } catch {}
            ...
            if userPointer.objectId == currentuser.objectId {
                ...
                cell.sImageButton.isHidden = true
            ...
            // ------------------------------------------------
                ...
                cell.backgroundColor = UIColor.clear
                cell.contentView.backgroundColor = UIColor.clear
                cell.rImageButton.isHidden = true
